...
import {fetchProperty} from '@/util/request';
...
const PropertyEditForm = () => {
    ...
    const handleAmenitiesChange=(e)=>{
        ...
        if(checked){
         ...
         //Updated state with updated array
            setFields((prevFields)=>({
                ...prevFields,
...
//this enctype for multiple images
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
               ...
               <div>
                <input
                    ...
                    onChange={handleAmenitiesChange}
                />
                <label htmlFor='amenity_washer_dryer'>Washer and dryer</label>
               </div>
               <div>
                <input
                    type='checkbox'
                    id='amenities_smart_tv'
                    name='amenities'
                    value='Smart TV'
                    className='mr-2'
